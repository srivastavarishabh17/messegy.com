...
import Logo from "@/public/messegylogo.png";
					...
					<div className="row">
						...
						<div className="col-xl-4 col-md-12">
							<div className="sofax-footer-wrap mr-15">
								<Link href="/">
									<Image src={Logo} alt="Messegy Logo" />
								</Link>

								<p>
									Messegy helps businesses automate WhatsApp conversations,
									capture leads, and scale customer engagement effortlessly.
								</p>
								...
								<div className="sofax-social-icon">
									<ul>
										...
										<li>
											<a href="https://www.facebook.com/messegyapp" target="_blank">
												<svg
													width="11"
													height="18"
													viewBox="0 0 11 18"
										...
										<li>
											<a href="https://www.instagram.com/messegy" target="_blank">
												<svg
													width="18"
													height="17"
													viewBox="0 0 18 17"
										...
										<li>
											<a href="https://in.linkedin.com/showcase/messegy" target="_blank">
												<svg
													width="16"
													height="16"
													viewBox="0 0 16 16"
						...
						<div className="col-xl-3 col-md-4">
							<div className="sofax-footer-menu">
								<h5>Get Started</h5>
								<p>Start automating your WhatsApp today.</p>

								<Link target="_blank" href="https://app.messegy.com/register" className="sofax-default-btn">
									Start Free
								</Link>
							</div>
						</div>
